...
public class Sudoku12x12LevelsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        levelHeading.setText(R.string._12x12Levels);

        list = new ArrayList<>();
        adapter = new LevelsAdapter(Sudoku12x12LevelsActivity.this, list, 2);
        loadTheLevels();
        setTheLayout();
    ...
    private void setTheLayout() {
        recyclerView.setLayoutManager(new GridLayoutManager(Sudoku12x12LevelsActivity.this, 4));
    ...
    private void loadTheLevels() {
        list.clear();
        levelsDataBase = new LevelsDataBase(Sudoku12x12LevelsActivity.this);
