...
public class SudokuBoard2 extends View {
    ...
    public SudokuBoard2(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.SudokuBoard2, 0, 0); // getting the array set

        try {
            bordersColor = a.getInteger(R.styleable.SudokuBoard2_bordersColor, 0); // assigning the color value seated from view
            cellFillColor = a.getInteger(R.styleable.SudokuBoard2_cellFillColor, 0);
            cellHighlightedColor = a.getInteger(R.styleable.SudokuBoard2_cellHighlightedColor, 0);
            letterColor = a.getInteger(R.styleable.SudokuBoard2_letterColor, 0);
            letterSolvedColor = a.getInteger(R.styleable.SudokuBoard2_letterSolvedColor, 0);
        } finally {
            a.recycle();
        }
    ...
    private void drawNumbers(Canvas canvas) {
        ...
        ArrayList<ArrayList<Object>> emptyBox = solver2.getEmptyBoxIndexes();
        try {
