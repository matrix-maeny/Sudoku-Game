...
public class SudokuBoard3 extends View {
    ...
    public SudokuBoard3(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.SudokuBoard3, 0, 0); // getting the array set

        try {
            bordersColor = a.getInteger(R.styleable.SudokuBoard3_bordersColor, 0); // assigning the color value seated from view
            cellFillColor = a.getInteger(R.styleable.SudokuBoard3_cellFillColor, 0);
            cellHighlightedColor = a.getInteger(R.styleable.SudokuBoard3_cellHighlightedColor, 0);
            letterColor = a.getInteger(R.styleable.SudokuBoard3_letterColor, 0);
            letterSolvedColor = a.getInteger(R.styleable.SudokuBoard3_letterSolvedColor, 0);
        } finally {
            a.recycle();
        }
        setTheSounds();
    ...
    private void drawNumbers(Canvas canvas) {
        ...
        ArrayList<ArrayList<Object>> emptyBox = solver3.getEmptyBoxIndexes();
